...
public class ItemAnimator extends SimpleItemAnimator {
    ...
    public ItemAnimator() {
        setRemoveDuration(animateDuration);
        setAddDuration(animateDuration);
    }

    public static final long animateDuration = 500;
    /**
    ...
    private void resetAnimation(RecyclerView.ViewHolder holder) {
        if (sDefaultInterpolator == null) {
            sDefaultInterpolator = new DecelerateInterpolator();
        }
